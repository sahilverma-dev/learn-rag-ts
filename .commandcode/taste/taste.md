...
- Prefers running models and supporting infrastructure self-hosted on their local network (e.g. Ollama for LLM + embeddings, a local Pinecone emulator) rather than depending on hosted cloud APIs. Confidence: 0.6
